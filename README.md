...
### 🚀 Welcome to IEEE IGDTUW Open Source Week![Ended]
...
| S.No | Project             | Domain / Tech Stack                                                                                                                                                                                                                   | Project GitHub Link                                                                | Maintainer(s)                                    |
|------|----------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|--------------------------------------------------|
...
| 2    | Ardh Naari Shakti    | React.js, MongoDB, Dialogflow                                                                                                                                                                                                       | [Ardh Naari Shakti Repository](https://github.com/Agarwalvidu/ArdhNaariShakti_Taara_Frontend) | [Sripriya Agarwal](https://github.com/sripriyaagarwal16), [Vidushi Agarwal](https://github.com/Agarwalvidu) |
...
| 4    | FountainCMS          | TypeScript, React, Node.js                                                                                                                                                                                                          | [FountainCMS Repository](https://github.com/building-for-fun/fountainCms)          | [Akshit Batra](https://github.com/building-for-fun) |
...
| 6    | NeuroSense           | Frontend: Streamlit (Python-based) • Backend: Python 3.8+ • AI/ML: Cohere API / OpenAI • APIs: YouTube Data API v3 / JioSaavn • Deployment: Streamlit Cloud compatible • Version Control: Git                                       | [NeuroSense Repository](https://github.com/Pragati1466/NeuroSense)                 | [Pragati](https://github.com/Pragati1466) |
| 7    | Shashkth Stree       | HTML, CSS, JS                                                                                                                                                                                                                       | [Shashkth Stree Repository](https://github.com/ssyy21/Shashkth_Stree)              | [Sneha Yadav](https://github.com/ssyy21) |
| 8    | AI-Health-Assistant  | Frontend: Streamlit (Python-based) • Backend: Python 3.8+ • AI/ML: TensorFlow (Keras) Neural Network, NLTK (NLP Processing) • Data Handling: NumPy, JSON                                                                          | [AI-Health-Assistant Repository](https://github.com/ssyy21/AI-Health-Assistant)     | [Sneha Yadav](https://github.com/ssyy21) |
| 9    | Habit Tracker        | Frontend: React 18, TypeScript, Vite • Styling: Tailwind CSS • Backend: Supabase (PostgreSQL, Auth, Realtime) • Icons: Lucide React • Deployment: Netlify                                   | [Habit Tracker Repository](https://github.com/Charushi06/Habit-Tracker)            | [Charushi](https://github.com/Charushi06) |
...
| 14   | Code A2Z             | React, Vite, MUI, Node, Express, MongoDB                                                                                                                                                                                            | [Code A2Z Repository](https://github.com/Code-A2Z/code-a2z)                        | [Avdhesh Varshney](https://github.com/Code-A2Z) |
| 15   | Jarvis               | Python, Machine Learning (ML), Deep Learning (DL), Large Language Models (LLMs), etc.                                                                                                       | [Jarvis Repository](https://github.com/Code-A2Z/jarvis)                            | [Avdhesh Varshney](https://github.com/Code-A2Z) |
| 16   | Paisable             | React, Vite, Tailwind CSS, Express, Node, MongoDB                                                                                                                                            | [Paisable Repository](https://github.com/Code-A2Z/paisable)                        | [Avdhesh Varshney](https://github.com/Code-A2Z) |
